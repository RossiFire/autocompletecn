        ...
        <PopoverPrimitive.Portal>
            ...
            >
                <PopoverPrimitive.Popup
                    ...
                    initialFocus={() => ctx.anchorRef.current?.querySelector('input') ?? false}
                    finalFocus={() => ctx.anchorRef.current?.querySelector('input') ?? false}
                    className={cn(
                        "max-h-60 overflow-y-auto p-1 w-(--anchor-width)",
